...
class _View_AboutComponent_Host0 extends import3.DebugAppView<any> {
  ...
  createInternal(rootSelector:string):import4.AppElement {
    ...
    this._AboutComponent_0_4 = new import1.AboutComponent();
...
function viewFactory_AboutComponent_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import3.AppView<any> {
  if ((renderType_AboutComponent_Host === (null as any))) { (renderType_AboutComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
  return new _View_AboutComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const AboutComponentNgFactory:import10.ComponentFactory<import1.AboutComponent> = new import10.ComponentFactory<import1.AboutComponent>('about',viewFactory_AboutComponent_Host0,import1.AboutComponent);
...
class _View_AboutComponent0 extends import3.DebugAppView<import1.AboutComponent> {
  ...
  createInternal(rootSelector:string):import4.AppElement {
    ...
    this._text_4 = this.renderer.createText(this._el_3,'About',this.debug(4,2,8));
...
export function viewFactory_AboutComponent0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import4.AppElement):import3.AppView<import1.AboutComponent> {
  if ((renderType_AboutComponent === (null as any))) { (renderType_AboutComponent = viewUtils.createRenderComponentType('/Users/yosuke/workspaces/javascript/ng2-studies/routing-with-lazy-load/src/app/about.component.ts class AboutComponent - inline template',0,import9.ViewEncapsulation.None,styles_AboutComponent,{})); }
